"""
IMPORTANT: THIS MODULE WAS NOT CODED BY ME!!!!!!!!!!!!!!
This is a public addon for the pygame library used to display videos
Link to project's GitHub repository: https://github.com/anrayliu/pyvidplayer
"""
